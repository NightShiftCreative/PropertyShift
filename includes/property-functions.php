                            ...
                            <div class="floor-plan-item"> 
                                ...
                                <div class="floor-plan-right">
                                    ...
                                    <div class="floor-plan-img">
                                        ...
                                        <input id="_btn" class="rao_upload_image_button" type="button" value="<?php esc_html_e('Upload Image', 'rype-real-estate'); ?>" />
            ...
            <table class="admin-module admin-module-upload no-border">
                <tr>
                    ...
                    <td class="admin-module-field">
                        ...
                        <input id="_btn" class="rao_upload_image_button" type="button" value="<?php echo esc_html_e('Upload Image', 'rype-real-estate'); ?>" />
    ...
    <tr class="form-field">
        ...
        <td>
            <div class="admin-module admin-module-tax-field admin-module-tax-img no-border">
                ...
                <input id="_btn" class="button-secondary rao_upload_image_button" type="button" value="<?php esc_html_e('Upload Image', 'rype-real-estate'); ?>" />
