...
function ns_real_estate_property_filter_details($post) {
	...
	$submit_text = isset( $values['rypecore_property_filter_submit_text'] ) ? esc_attr( $values['rypecore_property_filter_submit_text'][0] ) : esc_html__('Find Properties', 'ns-real-estate');
...
/*-----------------------------------------------------------------------------------*/
add_filter( 'manage_edit-ns-property-filter_columns', 'rype_real_estate_edit_property_filter_columns' ) ;
...
add_action( 'manage_ns-property-filter_posts_custom_column', 'rype_real_estate_manage_property_filter_columns', 10, 2 );
