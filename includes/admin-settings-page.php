...
function ns_real_estate_register_options() {
    ...
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_listing_crop' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_listing_display_time' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_listing_display_favorite' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_listing_display_share' );

    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_detail_template' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_detail_display_gallery_agent' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_detail_default_layout' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_detail_id' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_detail_items' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_detail_amenities_hide_empty' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_detail_map_zoom' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_detail_map_height' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_property_detail_agent_contact_form' );

    register_setting( 'ns-real-estate-settings-group', 'rypecore_custom_fields' );

    //AGENT SETTINGS
    register_setting( 'ns-real-estate-settings-group', 'rypecore_num_agents_per_page' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_agent_detail_slug', 'ns_real_estate_sanitize_slug' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_agent_listing_crop' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_agent_detail_items' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_agent_form_message_placeholder' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_agent_form_success' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_agent_form_submit_text' );

    //MAP SETTINGS
    register_setting( 'ns-real-estate-settings-group', 'rypecore_google_maps_api' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_home_default_map_zoom' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_home_default_map_latitude' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_home_default_map_longitude' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_google_maps_pin' );

    //MEMBER SETTINGS
    register_setting( 'ns-real-estate-settings-group', 'rypecore_members_my_properties_page' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_members_submit_property_page' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_members_submit_property_approval' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_members_add_locations' );
    register_setting( 'ns-real-estate-settings-group', 'rypecore_members_add_amenities' );

    //CURRENCY SETTINGS
    register_setting( 'ns-real-estate-settings-group', 'rype_real_estate_currency_symbol' );
    register_setting( 'ns-real-estate-settings-group', 'rype_real_estate_currency_symbol_position' );
    register_setting( 'ns-real-estate-settings-group', 'rype_real_estate_thousand_separator' );
    register_setting( 'ns-real-estate-settings-group', 'rype_real_estate_decimal_separator' );
    register_setting( 'ns-real-estate-settings-group', 'rype_real_estate_num_decimal' );
    register_setting( 'ns-real-estate-settings-group', 'rype_real_estate_default_area_postfix' );
    register_setting( 'ns-real-estate-settings-group', 'rype_real_estate_thousand_separator_area' );
    register_setting( 'ns-real-estate-settings-group', 'rype_real_estate_decimal_separator_area' );
            ...
            <div>
                ...
                <table class="admin-module">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <div class="toggle-switch" title="<?php if(get_option('rypecore_property_filter_display', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                                ...
                                <label class="toggle-switch-label" for="property_filter_display"><?php if(get_option('rypecore_property_filter_display', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div>
                ...
                <table class="admin-module">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <p><input type="radio" id="properties_default_layout" name="rypecore_properties_default_layout" value="grid" <?php if(esc_attr( get_option('rypecore_properties_default_layout', 'grid')) == 'grid') { echo 'checked'; } ?> /><?php echo esc_html_e('Grid', 'ns-real-estate'); ?></p>
                            <p><input type="radio" id="properties_default_layout" name="rypecore_properties_default_layout" value="row" <?php if(esc_attr( get_option('rypecore_properties_default_layout', 'grid')) == 'row') { echo 'checked'; } ?> /><?php echo esc_html_e('Row', 'ns-real-estate'); ?></p>
                        </td>
                    </tr>
                </table>
                ...
                <table class="admin-module">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <div class="toggle-switch" title="<?php if(get_option('rypecore_property_listing_header_display', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                                ...
                                <label class="toggle-switch-label" for="property_listing_header_display"><?php if(get_option('rypecore_property_listing_header_display', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <table class="admin-module">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <div class="toggle-switch" title="<?php if(get_option('rypecore_property_listing_crop', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                                ...
                                <label class="toggle-switch-label" for="property_listing_crop"><?php if(get_option('rypecore_property_listing_crop', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <table class="admin-module">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <div class="toggle-switch" title="<?php if(get_option('rypecore_property_listing_display_time', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                                ...
                                <label class="toggle-switch-label" for="property_listing_display_time"><?php if(get_option('rypecore_property_listing_display_time', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <table class="admin-module">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <div class="toggle-switch" title="<?php if(get_option('rypecore_property_listing_display_favorite', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                                ...
                                <label class="toggle-switch-label" for="property_listing_display_favorite"><?php if(get_option('rypecore_property_listing_display_favorite', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <table class="admin-module no-border">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <div class="toggle-switch" title="<?php if(get_option('rypecore_property_listing_display_share', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                                ...
                                <label class="toggle-switch-label" for="property_listing_display_share"><?php if(get_option('rypecore_property_listing_display_share', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div>
                ...
                <table class="admin-module">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <p><input type="radio" id="property_detail_template_classic" name="rypecore_property_detail_template" value="classic" <?php if(esc_attr( get_option('rypecore_property_detail_template', 'classic')) == 'classic') { echo 'checked'; } ?> /><?php echo esc_html_e('Classic', 'ns-real-estate'); ?></p>
                            <p><input type="radio" id="property_detail_template_full" name="rypecore_property_detail_template" value="full" <?php if(esc_attr( get_option('rypecore_property_detail_template', 'classic')) == 'full') { echo 'checked'; } ?> /><?php echo esc_html_e('Full Width Gallery', 'ns-real-estate'); ?></p>
                            <p><input type="radio" id="property_detail_template_agent_contact" name="rypecore_property_detail_template" value="agent_contact" <?php if(esc_attr( get_option('rypecore_property_detail_template', 'classic')) == 'agent_contact') { echo 'checked'; } ?> /><?php echo esc_html_e('Boxed Gallery', 'ns-real-estate'); ?></p>
                ...
                <table class="admin-module">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <div class="toggle-switch" title="<?php if(get_option('rypecore_property_detail_id') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                                ...
                                <label class="toggle-switch-label" for="property_detail_id"><?php if(get_option('rypecore_property_detail_id') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div>
                ...
                <table class="admin-module no-border">
                    <tr>
                        ...
                        <td class="admin-module-field">
                            <div class="toggle-switch" title="<?php if(get_option('rypecore_agent_listing_crop', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                                ...
                                <label class="toggle-switch-label" for="agent_listing_crop"><?php if(get_option('rypecore_agent_listing_crop', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                            </div>
                        </td>
                    </tr>
                </table>
                                ...
                                <div id="advanced-options-content-<?php echo esc_attr($slug); ?>" class="advanced-options-content hide-soft">  
                                    ...
                                    <?php if($slug == 'contact') { ?>
                                        <div class="admin-module">
                                            ...
                                            <input type="text" name="rypecore_agent_form_message_placeholder" value="<?php echo esc_attr( get_option('rypecore_agent_form_message_placeholder', esc_html__('I am interested in this property and would like to know more.', 'ns-real-estate')) ); ?>" />
                                        </div>
                                        <div class="admin-module">
                                            <label><?php echo esc_html_e('Success Message', 'ns-real-estate'); ?></label><br/>
                                            <input type="text" name="rypecore_agent_form_success" value="<?php echo esc_attr( get_option('rypecore_agent_form_success', esc_html__('Thanks! Your email has been delivered!', 'ns-real-estate')) ); ?>" />
                                        </div>
                                        <div class="admin-module">
                                            <label for="agent_form_submit_text"><?php esc_html_e('Submit Button Text', 'ns-real-estate'); ?></label><br/>
                                            <input type="text" id="agent_form_submit_text" name="rypecore_agent_form_submit_text" value="<?php echo esc_attr( get_option('rypecore_agent_form_submit_text', esc_html__('Contact Agent', 'ns-real-estate')) ); ?>" />
                                        </div>
                                    <?php } ?>
    ...
    <div id="members" class="tab-content">
        ...
        <table class="admin-module">
            <tr>
                ...
                <td class="admin-module-field">
                    <div class="toggle-switch" title="<?php if(get_option('rypecore_members_submit_property_approval', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                        ...
                        <label class="toggle-switch-label" for="members_submit_property_approval"><?php if(get_option('rypecore_members_submit_property_approval', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <table class="admin-module">
            <tr>
                ...
                <td class="admin-module-field">
                    <div class="toggle-switch" title="<?php if(get_option('rypecore_members_add_locations', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                        ...
                        <label class="toggle-switch-label" for="members_add_locations"><?php if(get_option('rypecore_members_add_locations', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <table class="admin-module">
            <tr>
                ...
                <td class="admin-module-field">
                    <div class="toggle-switch" title="<?php if(get_option('rypecore_members_add_amenities', 'true') == 'true') { esc_html_e('Active', 'ns-real-estate'); } else { esc_html_e('Disabled', 'ns-real-estate'); } ?>">
                        ...
                        <label class="toggle-switch-label" for="members_add_amenities"><?php if(get_option('rypecore_members_add_amenities', 'true') == 'true') { echo '<span class="on">'.esc_html__('On', 'ns-real-estate').'</span>'; } else { echo '<span>'.esc_html__('Off', 'ns-real-estate').'</span>'; } ?></label>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div id="currency" class="tab-content">
        ...
        <table class="admin-module">
             <tr>
                ...
                <td class="admin-module-field"><input type="text" id="currency_symbol" name="rype_real_estate_currency_symbol" value="<?php echo $currency_options['symbol']; ?>" /></td>
            </tr>
        </table>
        ...
        <table class="admin-module">
            <tr>
                ...
                <td class="admin-module-field">
                    <p><input type="radio" id="currency_symbol_position" name="rype_real_estate_currency_symbol_position" value="before" <?php if($currency_options['symbol_position'] == 'before') { echo 'checked'; } ?> /><?php echo esc_html_e('Display before price', 'ns-real-estate'); ?></p>
                    <p><input type="radio" id="currency_symbol_position" name="rype_real_estate_currency_symbol_position" value="after" <?php if($currency_options['symbol_position'] == 'after') { echo 'checked'; } ?> /><?php echo esc_html_e('Display after price', 'ns-real-estate'); ?></p>
                </td>
            </tr>
        </table>
        ...
        <table class="admin-module">
            <tr>
                ...
                <td class="admin-module-field"><input type="text" id="thousand_separator" name="rype_real_estate_thousand_separator" value="<?php echo $currency_options['thousand']; ?>" /></td>
            </tr>
        </table>
        ...
        <table class="admin-module">
            <tr>
                ...
                <td class="admin-module-field"><input type="text" id="decimal_separator" name="rype_real_estate_decimal_separator" value="<?php echo $currency_options['decimal']; ?>" /></td>
            </tr>
        </table>
        ...
        <table class="admin-module no-border">
            <tr>
                ...
                <td class="admin-module-field"><input type="number" min="0" max="5" id="num_decimal" name="rype_real_estate_num_decimal" value="<?php echo $currency_options['decimal_num']; ?>" /></td>
            </tr>
        </table>
        ...
        <table class="admin-module no-border">
            <tr>
                ...
                <td class="admin-module-field"><input type="text" id="default_area_postfix" name="rype_real_estate_default_area_postfix" value="<?php echo $currency_options['default_area_postfix']; ?>" /></td>
            </tr>
        </table>
        ...
        <table class="admin-module no-border">
            <tr>
                ...
                <td class="admin-module-field"><input type="text" id="thousand_separator_area" name="rype_real_estate_thousand_separator_area" value="<?php echo $currency_options['thousand_area']; ?>" /></td>
            </tr>
        </table>
        ...
        <table class="admin-module no-border">
            <tr>
                ...
                <td class="admin-module-field"><input type="text" id="decimal_separator_area" name="rype_real_estate_decimal_separator_area" value="<?php echo $currency_options['decimal_area']; ?>" /></td>
            </tr>
        </table>
        ...
        <table class="admin-module no-border">
            <tr>
                ...
                <td class="admin-module-field"><input type="number" min="0" max="5" id="num_decimal_area" name="rype_real_estate_num_decimal_area" value="<?php echo $currency_options['decimal_num_area']; ?>" /></td>
            </tr>
        </table>
